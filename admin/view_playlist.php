...
<head>
   ...
   <title>Chi tiết danh sách phát</title>
...
<section class="contents">
   ...
   <?php
         ...
         echo '<p class="empty">Không có video nào được thêm! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Thêm videos</a></p>';
      }
   ?>

...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Xem khóa học</a>
      </div>
   <?php
         }
      }else{
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Xóa danh sách phát" class="delete-btn" onclick="return confirm('Bạn chắc chắn muốn xóa danh sách phát?');" name="delete">
         </form>

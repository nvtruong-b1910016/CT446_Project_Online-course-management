...
<section class="playlists">
   ...
   <h1 class="heading">Danh sách phát khóa học</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Tạo danh sách phát</h3>
      ...
      <?php
         ...
         echo '<p class="empty">Chưa có danh sách phát được thêm!</p>';
      }
      ?>

...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="Vui lòng nhập tiêu đề!" value="<?= $fetch_playlist['title']; ?>" class="box">
      <p>Mô tả <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Vui lòng nhập mô tả!" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
      ...
      <input type="submit" value="Update danh sách phát" name="submit" class="btn">
      <div class="flex-btn">
         <input type="submit" value="Xóa" class="delete-btn" onclick="return confirm('Bạn chắc chắn xóa danh sách phát?');" name="delete">

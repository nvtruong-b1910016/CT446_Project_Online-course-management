...
if(isset($_POST['submit'])){
   ...
   if(!empty($profession)){
      ...
      $message[] = 'Lĩnh vực được cập nhật thành công!';
   }
      ...
      <div class="flex">
         <div class="col">
            ...
            <select name="profession" class="box">
               ...
               <option value="desginer">Business</option>
               <option value="desginer">Design</option>
               <option value="musician">Marketing</option>
         ...
         <div class="col">
            <p>Mật khẩu cũ </p>
            <input type="password" name="old_pass" placeholder="Vui lòng nhập mật khẩu cũ!" maxlength="20"  class="box">
            <p>Mật khẩu mới </p>
            <input type="password" name="new_pass" placeholder="Vui lòng nhập mật khẩu mới!" maxlength="20"  class="box">
            <p>Xác nhận mật khẩu mới </p>
            <input type="password" name="cpass" placeholder="Vui lòng xác nhận mật khẩu mới!" maxlength="20"  class="box">
         </div>
      </div>
      <p>Cập nhật ảnh :</p>

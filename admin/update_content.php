...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="Vui lòng nhập tiêu đề!" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Cập nhật mô tả <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Vui lòng nhập mô tả!" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      ...
      <input type="submit" value="Cập nhật nội dung" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Xem khóa học</a>
         <input type="submit" value="Xóa nội dung" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }

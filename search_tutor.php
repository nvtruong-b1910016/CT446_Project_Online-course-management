...
<section class="teachers">
   ...
   <h1 class="heading">Gia sư</h1>

   <form action="" method="post" class="search-tutor">
      <input type="text" name="search_tutor" maxlength="100" placeholder="Tìm kiếm gia sư..." required>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Tổng videos : <span><?= $total_contents ?></span></p>
         <p>Tổng lượt thích : <span><?= $total_likes ?></span></p>
         <p>Tổng bình luận : <span><?= $total_comments ?></span></p>
         <form action="tutor_profile.php" method="post">
            <input type="hidden" name="tutor_email" value="<?= $fetch_tutor['email']; ?>">
            <input type="submit" value="Xem profile" name="tutor_fetch" class="inline-btn">
         </form>
      </div>
      <?php
               }
            }else{
               echo '<p class="empty">Không thấy kết quả!</p>';
            }
         }else{

   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>Đã đánh dấu</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Đánh dấu danh sách phát</span></button>
            <?php
               }
            ?>
         </form>
...
<section class="videos-container">
   ...
   <h1 class="heading">Danh sách phát videos</h1>

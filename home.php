...
<section class="quick-select">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <h3 class="title">Thống kê cá nhân</h3>
         <p><span> <i class="fas fa-heart"></i></span> Tổng số lượt thích : <span><?= $total_likes; ?></span></p>
         <a href="likes.php" class="inline-btn">Xem lượt thích</a>
         <p><span> <i class="fas fa-comment"></i></span> Tổng số bình luận : <span><?= $total_comments; ?></span></p>
         <a href="comments.php" class="inline-btn">Xem bình luận</a>
         <p><span> <i class="fas fa-bookmark"></i></span> Danh sách đã đánh dấu : <span><?= $total_bookmarked; ?></span></p>
         <a href="bookmark.php" class="inline-btn">Xem đánh dấu</a>
      </div>
      <?php
         }else{ 
      ?>
      ...
      <div class="box">
         <h3 class="title">Khóa học hàng đầu</h3>
         <div class="flex">
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">Chưa có khóa học được thêm vào!</p>';
      }
      ?>

   ...
   if($user_id != ''){
      ...
      if($select_content->rowCount() > 0){
         ...
         if($select_comment->rowCount() > 0){
            ...
            $message[] = 'Bình luận mới đã được thêm vào!';
         }
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-heart"></i><span><?= $total_likes; ?> Số lượt thích</span></p>
      </div>
      <div class="tutor">
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="Viết bình luận..." maxlength="1000" cols="30" rows="10"></textarea>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Bạn chắn chắn muốn xóa bình luận?');">Xóa bình luận</button>
         </form>
         <?php
         }
         ?>
